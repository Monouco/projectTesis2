...
//Reading files
void readEnv(const char* fileName, int*& env, int*& feasible, int*& priority, int& height, int& width, Node*& wIndex, Node*& hIndex, double* minVal, 
			double* maxVal, int offset, int maxCam, int numModels);
